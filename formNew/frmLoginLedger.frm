...
Private Sub cmdOk_Click()
 ...
 If change_Pass = "b" Then
    ...
    'RS.Open "select * from pass where pass='" & txtpass.Text & "' and Module_='" & module_ & "'", con, adOpenDynamic, adLockOptimistic
    RS.Open "select * from pass where pass='" & dvalue & "' and Module_='" & module_ & "'", con, adOpenDynamic, adLockOptimistic
 ...
 Else
    ...
    If (module_ = "Invoicing" Or module_ = "Canvassing") Then
       frmBillList.Show
    Else

...
Begin VB.Form frmBasilSales 
   ...
   Begin VB.Frame panel 
      ...
      Begin VB.ComboBox txtMark 
         Height          =   315
         ItemData        =   "frmBasilSales.frx":0000
         Left            =   3975
         List            =   "frmBasilSales.frx":0002
      ...
      Begin VB.PictureBox Picture5 
         ...
         Begin VB.CommandButton Commandprintnh 
            ...
            Height          =   690
            Left            =   6465
            Picture         =   "frmBasilSales.frx":0004
            Style           =   1  'Graphical
            TabIndex        =   22
            Top             =   45
            Width           =   1080
         ...
         Begin VB.CommandButton Commandadd 
            ...
            Height          =   690
            Left            =   -15
            Picture         =   "frmBasilSales.frx":0BE8
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   45
            Width           =   1080
         ...
         Begin VB.CommandButton CommandReturn 
            ...
            Height          =   690
            Left            =   8625
            Picture         =   "frmBasilSales.frx":17CC
            Style           =   1  'Graphical
            TabIndex        =   20
            Top             =   45
            Width           =   1080
         ...
         Begin VB.CommandButton Commandsearch 
            ...
            Height          =   690
            Left            =   5385
            Picture         =   "frmBasilSales.frx":23B0
            Style           =   1  'Graphical
            TabIndex        =   18
            Top             =   45
            Width           =   1080
         ...
         Begin VB.CommandButton Commanddelete 
            ...
            Height          =   690
            Left            =   4305
            Picture         =   "frmBasilSales.frx":2F94
            Style           =   1  'Graphical
            TabIndex        =   17
            Top             =   45
            Width           =   1080
         ...
         Begin VB.CommandButton Commandabandon 
            ...
            Height          =   690
            Left            =   3225
            Picture         =   "frmBasilSales.frx":3B78
            Style           =   1  'Graphical
            TabIndex        =   33
            Top             =   45
            Width           =   1080
         ...
         Begin VB.CommandButton Commandsave 
            ...
            Height          =   690
            Left            =   2145
            Picture         =   "frmBasilSales.frx":4102
            Style           =   1  'Graphical
            TabIndex        =   29
            Top             =   45
            Width           =   1080
         ...
         Begin VB.CommandButton Commandedit 
            ...
            Height          =   690
            Left            =   1065
            Picture         =   "frmBasilSales.frx":4CE6
            Style           =   1  'Graphical
            TabIndex        =   31
            Top             =   45
            Width           =   1080
   ...
   End
End
Attribute VB_Name = "frmBasilSales"
...
rs1.Open "casha_basil", con, adOpenDynamic, adLockReadOnly, adCmdTable
...
If Not rs1.EOF Then
    ...
    kk.Open "select * from cashb_basil where " & stringyear & " and invoiceno=" + Trim(rs1!invoiceNo) + " order by printorder,sno ", con, adOpenDynamic, adLockReadOnly, adCmdText
    If Not kk.BOF Then
        kk.MoveFirst
...
printagain2:
                ...
                Line = Line + 1
                tdata.Open "select sum(amount)as sumamt, sum(amount-netamount) as sumdis from cashb_basil where invoiceno=" + Trim(rs1!invoiceNo) + " and printorder =" + Trim(Str(cdiscount)) + " group by printorder", con, adOpenDynamic, adLockReadOnly, adCmdText
    ...
    Line = Line + 2
    If kk.State = 1 Then kk.close
    kk.Open "Select * from cashc_basil where " & stringyear & " and invoiceno=" + Trim(Me.I_NO.Text), con, adOpenDynamic, adLockReadOnly, adCmdText
    If Not kk.BOF Then
       Do While Not kk.EOF
             If kk!amount > 0 Then
        ...
        Line = Line + 2
        kk.close
        kk.Open "Select * from casha_basil where " & stringyear & " and invoiceno=" + Trim(Me.I_NO.Text), con, adOpenDynamic, adLockReadOnly, adCmdText
        If Not kk.BOF Then
            If kk!txt1a <> 0 Then
...
printagain2:
                ...
                Line = Line + 1
                tdata.Open "select sum(amount)as sumamt, sum(amount-netamount) as sumdis from cashb_basil where " & stringyear & " and invoiceno=" + Trim(rs1!invoiceNo) + " and printorder =" + Trim(Str(cdiscount)) + " group by printorder", con, adOpenDynamic, adLockReadOnly, adCmdText
                If Not tdata.BOF Then
...
Else
  ...
  rs1.Open "select *  from AgentMaster where " & stringyear & " and AgentName='" & cmbAgentName.Text & "' and " & stringyear & " order by agentname", con, adOpenDynamic, adLockReadOnly, adCmdText
...
con.Execute "update CounterSale set " & "[" & I & "]" & " = " & sum & "" & " where  agent='" & rs2(0) & "' and " & I & " = " & I
DoEvents
DoEvents
...
On Error Resume Next
    ...
    If Edit = False Then
    If con.Execute("Select max(invoiceno) from casha_basil")(0) >= Val(Trim(Me.I_NO.Text)) Then
        Me.I_NO.Text = con.Execute("Select max(invoiceno) from casha_basil")(0) + 1
...
Private Sub Commanddelete_Click()
    ...
    If rs1.State = 1 Then rs1.close
    rs1.Open "select * from casha_basil where " & stringyear & " and invoiceno=" & I_NO.Text & "", con
    If rs1.EOF = False Then
       
       If rs_h.State = 1 Then rs_h.close
       rs_h.Open "select * from casha_basil where " & stringyear & " and invoiceno=" & I_NO.Text & "", con
...
If MsgBox("Are You Sure, Delete it ?", vbYesNo) = vbNo Then
        Exit Sub
Else
                con.Execute ("delete  from casha_basil where " & stringyear & " and INVOICENO = " + Trim(I_NO.Text))
                con.Execute ("delete  from cashb_basil where " & stringyear & " and INVOICENO = " + Trim(I_NO.Text))
                con.Execute ("delete  from cashc_basil where " & stringyear & " and INVOICENO = " + Trim(I_NO.Text))
                invoiceabandon
End If
End Sub
...
Private Sub Commandedit_Click()
   If I_NO.Text <> "" Then
    ...
    DoEvents
    con.Execute ("Delete  from CASHCTMP_basil")
    DoEvents
    
    con.Execute ("insert into CASHCTMP_basil(INVOICENO,INVOICEDATE,GENLEDGER,SUBLEDGER,GAMOUNT," & _
    "Rate,AMOUNT,DEBITORCREDIT,[TEXT],RYN,Fyear,setupid)  select INVOICENO,INVOICEDATE,GENLEDGER," & _
    "SUBLEDGER,GAMOUNT,Rate,AMOUNT,DEBITORCREDIT,[TEXT],RYN,Fyear,setupid from cashc_basil where " & stringyear & " and INVOICENO = " + Trim(I_NO.Text))
...
'       RS.AddNew
'   End If
'   RS!In = CON.Execute("Select max(invoiceno) from casha_basil")(0)
'   RS.Update
'   RS.close
   Unload Me
   addoredit = False
...
Private Sub Commandsave_Click()
    ...
    If rs1.State = 1 Then rs1.close
    rs1.Open "select * from casha_basil where " & stringyear & " and invoiceno=" & I_NO.Text & "", con, adOpenKeyset, adLockReadOnly
    If rs1.EOF = False Then
       
       If rs_h.State = 1 Then rs_h.close
       rs_h.Open "select * from casha_basil where " & stringyear & " and invoiceno=" & I_NO.Text & "", con, adOpenKeyset, adLockReadOnly
...
If Edit = False Then
    ...
    If check_Duplikate("casha_basil", I_NO.Text) = True Then
...
If Trim(I_NO.Text) <> "" And Trim(i_dt.Text) <> "" And Trim(customercode.Text) <> "" Then
   ...
   If RS.State = 1 Then RS.close
   LAMOUNT = 0
   RS.Open "select * from casha_basil where  " & stringyear & " and invoiceno<=0", con, adOpenDynamic, adLockOptimistic
   If Not Edit Then
again:
      If con.Execute("Select max(invoiceno) from casha_basil")(0) >= Val(Trim(Me.I_NO.Text)) Then
...
err1:
   ...
   On Error GoTo 0
   RS.close
   RS.Open "select * from cashb_basil where " & stringyear & " and invoiceno<=0", con, adOpenDynamic, adLockOptimistic
   Dim I As Integer
   RRRR = grid1.Row
   CCCC = grid1.Col
   For I = 1 To maxrow
  ...
  RS.close
  grid1.TopRow = 1
  RS.Open "select * from cashc_basil where " & stringyear & " and invoiceno<=0 ", con, adOpenDynamic, adLockOptimistic
  '/******
  'Dim I, x As Integer
   ...
   Set temprs = New ADODB.Recordset
       For I = 1 To frmEndPartTrans.vs.rows - 1
           ...
           If Trim(frmEndPartTrans.vs.Text) <> "" Then
              ...
              If Edit Then
                 temprs.Open "select * from CASHCTMP_basil WHERE " & stringyear & " and INVOICENO = " & Val(Me.I_NO.Text) & "", con, adOpenDynamic, adLockReadOnly, adCmdText
                ...
                temprs.close
              Else
                 temprs.Open "select * from INVOICEEND where " & stringyear & " and type='cashbasil'", con, adOpenDynamic, adLockReadOnly, adCmdText
                 If frmEndPartTrans.vs.Text <> "" Then
                    temprs.Find "TEXT='" + Trim(frmEndPartTrans.vs.Text) + "'"
                    RS!Genledger = temprs!Genledger & ""
                    RS!subledger = temprs!subledger & ""
      ...
      RS.close
       ...
       con.Execute ("delete from CASHCTMP_basil where " & stringyear & " and INVOICENO = " + Trim(I_NO.Text))
...
Private Sub Commandsearch_Click()
   searchType = "inv"
   sqlQry = "select InvoiceNo,InvoiceDate,Subledger,NetAmount from CASHA_basil where InvoiceNo"
   orderby = "order by InvoiceNo"
   
   popuplist10 "select InvoiceNo,InvoiceDate,Subledger,NetAmount from CASHA_basil where " & stringyear & "  order by InvoiceNo", con
End Sub
...
Set RS = New ADODB.Recordset
 ...
 If RS.State = 1 Then RS.close
 RS.Open "select * from GodownMaster where " & stringyear & " and len(Godwn)<=3 order by Godwn", con, adOpenDynamic, adLockReadOnly, adCmdText
 If Not RS.EOF Then
     Do While Not RS.EOF
...
If RS.State = 1 Then RS.close
RS.Open "select Distinct categorycode from DISCCATS where " & stringyear & " " & _
" order by categorycode", con, adOpenDynamic, adLockReadOnly, adCmdText
If Not RS.EOF Then
    Do While Not RS.EOF
...
End If
    ...
    kk.Open "SELECT MAX(INVOICENO) FROM casha_basil where " & stringyear & " ", con, adOpenDynamic, adLockReadOnly, adCmdText
...
Sub I_NO_LostFocus()
    ...
    Else
        If RS.State = 1 Then RS.close
        RS.Open "Select * from  casha_basil where " & stringyear & " and INVOICENO = " + Trim(I_NO.Text) + "", con, adOpenStatic, adLockReadOnly
        If RS.EOF Then
    ...
    '*/**/*/*/*/*//*/*
    If RS.State = 1 Then RS.close
    RS.Open "Select * from cashb_basil where " & stringyear & " and INVOICENO =" + Trim(I_NO.Text) + "  order by SNO ", con, adOpenStatic, adLockReadOnly
    If Not RS.EOF Then
            grid1.Row = 1
            grid1.Col = 1
            Do While Not RS.EOF
    ...
    If Not rs1.EOF Then
        Print #1, " To,"; Tab(T1 - 3); rs1!subledger; Tab(T5); "Estimate No. : "; Trim(rs1!invoiceNo); Tab(T8 + 5); "Dt. "; Tab(T8 + 12); rs1!invoiceDate 'Chr(27) + Chr(15);
            ...
            If kk.State = 1 Then
                kk.close
            End If
            kk.Open "select * from cashb_basil where " & stringyear & " and invoiceno=" + Trim(rs1!invoiceNo) + " order by discount,printorder", con, adOpenDynamic, adLockReadOnly, adCmdText
            If Not kk.BOF Then
                kk.MoveFirst
                Dim cdiscount As Double
                Dim sno As Integer
...
printagain2:
                        ...
                        tdata.Open "select sum(amount) from cashb_basil where " & stringyear & " and invoiceno=" + Trim(rs1!invoiceNo) + " and discount=" + Trim(Str(cdiscount)) + " group by discount", con, adOpenDynamic, adLockReadOnly, adCmdText
                        If Not tdata.BOF Then
...
If Not rs1.EOF Then
    ...
    End If
    If kk.State = 1 Then kk.close
    kk.Open "select * from cashb_basil where " & stringyear & " and invoiceno=" + Trim(rs1!invoiceNo) + " order by discount,sno ", con, adOpenDynamic, adLockReadOnly, adCmdText
    If Not kk.BOF Then
        kk.MoveFirst
        Dim cdiscount As Double
        Dim sno As Integer
...
printagain2:
                ...
                Line = Line + 1
                tdata.Open "select sum(amount)as sumamt, sum(amount-netamount) as sumdis from cashb_basil where " & stringyear & " and invoiceno=" + Trim(rs1!invoiceNo) + " and discount=" + Trim(Str(cdiscount)) + " group by discount", con, adOpenDynamic, adLockReadOnly, adCmdText
                If Not tdata.BOF Then

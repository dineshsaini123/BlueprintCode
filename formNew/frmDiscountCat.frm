...
Begin VB.Form frmDiscountCat 
   ...
   Begin VB.Frame panel 
      ...
      Begin VB.Frame buttonFrame 
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Height          =   720
            Left            =   3945
            Picture         =   "frmDiscountCat.frx":0000
            Style           =   1  'Graphical
            TabIndex        =   12
            Top             =   1260
            Width           =   975
         ...
         Begin VB.CommandButton cmdSearch 
            ...
            Height          =   720
            Left            =   4920
            Picture         =   "frmDiscountCat.frx":0BE4
            Style           =   1  'Graphical
            TabIndex        =   11
            Top             =   1260
            Width           =   975
         ...
         Begin VB.CommandButton cmdExit_12 
            ...
            Height          =   720
            Left            =   5580
            Picture         =   "frmDiscountCat.frx":17C8
            Style           =   1  'Graphical
            TabIndex        =   10
            Top             =   90
            Width           =   1290
         ...
         Begin VB.CommandButton cmdEdit_4 
            ...
            Height          =   720
            Left            =   4170
            Picture         =   "frmDiscountCat.frx":23AC
            Style           =   1  'Graphical
            TabIndex        =   9
            Top             =   90
            Width           =   1290
         ...
         Begin VB.CommandButton cmdDelete_3 
            ...
            Height          =   720
            Left            =   2760
            Picture         =   "frmDiscountCat.frx":27B9
            Style           =   1  'Graphical
            TabIndex        =   5
            Top             =   90
            Width           =   1290
         ...
         Begin VB.CommandButton cmdSave_2 
            ...
            Height          =   720
            Left            =   1365
            Picture         =   "frmDiscountCat.frx":339D
            Style           =   1  'Graphical
            TabIndex        =   4
            Top             =   90
            Width           =   1290
         ...
         Begin VB.CommandButton cmdAdd_1 
            ...
            Height          =   720
            Left            =   45
            Picture         =   "frmDiscountCat.frx":3F81
            Style           =   1  'Graphical
            TabIndex        =   8
            Top             =   90
            Width           =   1245
      ...
      Begin VB.Image imgFile 
         Height          =   240
         Left            =   7245
         Picture         =   "frmDiscountCat.frx":4B65
         Top             =   2610
         Visible         =   0   'False
         Width           =   240
      End
   ...
   End
End
Attribute VB_Name = "frmDiscountCat"
...
SQL = "SELECT DISCCATS.AutoId,DISCCATS.categorycode, DISCCATS.groupcode, GROUPS.groupname," & _
" DISCCATS.discountrate FROM GROUPS LEFT JOIN DISCCATS ON GROUPS.groupcode = DISCCATS.groupcode where (DISCCATS.fyear='" & session & "' and DISCCATS.setupid=" & setupid & ") order by Categorycode"
...
If MsgBox("want To delete ?", vbInformation + vbYesNo) = vbYes Then
 ...
 con.BeginTrans
 con.Execute "delete from DISCCATS where AutoId=" & lblId & " and " & stringyear
 con.CommitTrans
...
If edit1 = True Then
   con.Execute "update DISCCATS set categorycode='" & UCase(txtDisCode) & "',groupcode='" & cboGpCode & "'," & _
...
con.BeginTrans
con.Execute "INSERT INTO  [DISCCATS]" & _
           "([categorycode]" & _
           ",[groupcode]" & _
           ",[discountrate]" & _
           ",[Fyear]" & _
...
If KeyCode = 113 Then
   'SELECT Categorycode,Groupcode,Discountrate FROM [chitraData].[dbo].[DISCCATS]
    'popuplist "select SELECT Categorycode,Groupcode,Discountrate FROM DISCCATS where " & stringyear & " order by Categorycode", CON
    value = "SELECT Categorycode,Groupcode,Discountrate FROM DISCCATS where " & stringyear & " order by Categorycode"

...
namespace MailSystem.rpt {
    ...
    public class CreditNoteCH : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "MailSystem.rpt.CreditNoteCH.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCreditNoteCH : Component, ICachedReport {
        
        public CachedCreditNoteCH() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CreditNoteCH rpt = new CreditNoteCH();
            rpt.Site = this.Site;
            return rpt;
        }

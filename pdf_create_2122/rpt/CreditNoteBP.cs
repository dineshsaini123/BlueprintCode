...
namespace MailSystem.rpt {
    ...
    public class CreditNoteBP : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "MailSystem.rpt.CreditNoteBP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCreditNoteBP : Component, ICachedReport {
        
        public CachedCreditNoteBP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CreditNoteBP rpt = new CreditNoteBP();
            rpt.Site = this.Site;
            return rpt;
        }

...
namespace MailSystem.rpt {
    ...
    public class invoiceBP : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "MailSystem.rpt.invoiceBP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedinvoiceBP : Component, ICachedReport {
        
        public CachedinvoiceBP() {
        }

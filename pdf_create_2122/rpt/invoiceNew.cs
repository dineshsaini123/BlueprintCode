...
namespace MailSystem.rpt {
    ...
    public class invoiceNew : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "MailSystem.rpt.invoiceNew.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedinvoiceNew : Component, ICachedReport {
        
        public CachedinvoiceNew() {
        }

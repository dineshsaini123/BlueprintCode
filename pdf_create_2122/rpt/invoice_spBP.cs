...
namespace MailSystem.rpt {
    ...
    public class invoice_spBP : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "MailSystem.rpt.invoice_spBP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedinvoice_spBP : Component, ICachedReport {
        
        public Cachedinvoice_spBP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            invoice_spBP rpt = new invoice_spBP();
            rpt.Site = this.Site;
            return rpt;
        }
